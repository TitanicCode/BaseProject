 ...
 * generated in the com.helen.ws.personservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersonAllResponse_QNAME = new QName("personservice.ws.helen.com", "getPersonAllResponse");
    private final static QName _AddPerson_QNAME = new QName("personservice.ws.helen.com", "addPerson");
    private final static QName _AddPersonResponse_QNAME = new QName("personservice.ws.helen.com", "addPersonResponse");
    private final static QName _GetPersonAll_QNAME = new QName("personservice.ws.helen.com", "getPersonAll");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.helen.ws.personservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "personservice.ws.helen.com", name = "getPersonAllResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "personservice.ws.helen.com", name = "addPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "personservice.ws.helen.com", name = "addPersonResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "personservice.ws.helen.com", name = "getPersonAll")
