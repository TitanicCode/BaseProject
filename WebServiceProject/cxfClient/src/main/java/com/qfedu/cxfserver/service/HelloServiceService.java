 ...
 * 2018-06-30T10:50:34.575+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "HelloServiceService", 
                  wsdlLocation = "http://127.0.0.1:8888/hello?wsdl",
                  targetNamespace = "http://service.cxfserver.qfedu.com/") 
public class HelloServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.cxfserver.qfedu.com/", "HelloServiceService");
    public final static QName HelloServicePort = new QName("http://service.cxfserver.qfedu.com/", "HelloServicePort");
    static {
        URL url = null;
        try {
            ...
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8888/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
