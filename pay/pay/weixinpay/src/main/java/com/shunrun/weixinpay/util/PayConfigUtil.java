package com.shunrun.weixinpay.util;
...
/**
 * Created by jackiechan on 18-7-23/上午9:42
 */
public class PayConfigUtil {
    ...
    public static String NOTIFY_URL = "http://ceshi.qfjava.cn/weixinzhifu/resultservlet";
