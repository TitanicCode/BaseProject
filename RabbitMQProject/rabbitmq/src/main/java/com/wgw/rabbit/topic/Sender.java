...
public class Sender {
    ...
    public static void main(String[] args) throws Exception{
        ...
        channel.exchangeDeclare(EXCHANGE_NAME,"topic");//声明一个路由类型的交换机,类型必须写direct
        String message = "瞧一瞧看一看啦,新鲜的羊肉串了,一串只要五毛钱了";
        channel.basicPublish(EXCHANGE_NAME, "key.dasdasd", null, message.getBytes());
